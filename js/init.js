...
! function(t) {
    ...
    var e = !1,
        ...
        o = {
            init: function() {
                o.ready(), o.menuCenter(), o.imgToSVG(), o.BgImg(), o.totopFixer(), o.slider(), o.headerFixer(), o.fn_cs_counter(), o.video(), o.collection(), o.contactForm(), o.totopScroll(), o.seachSomething(), o.walletAndLeftNavOpener(), o.resizeWalletAndLeftNav(), o.headerAnchor(), o.isotope(), o.qnt(), o.countdown(), o.hold(), o.filterItems(), o.applyFilter(), o.navSubMenu(), o.roadmapSwiper(), o.floww(), o.accordion(), o.hero4Swiper(), o.rippleEffect(), o.fullSlider()
            },
            fullSlider: function() {
                        ...
                        on: {
                            ...
                            progress: function() {
                                for (var e = 0; e < this.slides.length; e++) {
                                    ...
                                    t(this.slides[e]).find(".abs_img").css({
                                        transform: "translate" + a + "(" + i + "px)"
                                    })
                                }
                            },
                            touchStart: function() {
            ...
            rippleEffect: function() {
                t("#ripple").length && t("#ripple").ripples({
                    resolution: 500,
                    dropRadius: 20,
                    perturbance: .04
                })
            ...
            accordion: function() {
                t(".fn_cs_accordion").each(function() {
                    ...
                    e.find(".active").each(function() {
                        ...
                        return e.hasClass("active") ? e.removeClass("active").find(".acc_content").slideUp(300) : (e.siblings(".active").removeClass("active").find(".acc_content").slideUp(300), e.addClass("active").find(".acc_content").slideDown(300)), !1
                    })
                })
            },
            floww: function() {
            ...
            flow_calc: function(t) {
                var e = t.width(),
                    ...
                    s = t.find("ul"),
                    l = s.children("li");
                s.height(r + "px"), l.find(".img_holder img").css({
                    width: i + "px",
                    height: r - o + "px"
                }), l.css({
                    width: i + "px",
            ...
            roadmapSwiper: function() {
                t(".fn_cs_roadmap .swiper-container").each(function() {
                    ...
                    o.roadmapStep(a, i, n), a.on("slideChange", function() {
            ...
            menuCenter: function() {
                var e = t(".header .trigger_logo"),
                    ...
                    o = 0,
                    i = 0;
                e.length && (o = parseInt(e.width())), a.length && (i = parseInt(a.width())), o < i ? n.css({
                    paddingLeft: i - o + "px"
                }) : n.css({
                    paddingRight: o - i + "px"
                }), n.css({
            ...
            navSubMenu: function() {
                t(".metaportal_fn_leftnav .nav_holder a").off().on("click", function() {
                    ...
                    return a.length ? (e.parent().siblings().children("a").removeClass("active"), e.addClass("active"), n++, a.find(">li>.prev").length || a.prepend('<li><a href="#" class="prev"><span class="creative_link">' + i + e.text() + "</span></a></li>"), t(".metaportal_fn_leftnav .nav_holder > ul").css({
                        transform: "translateX(-" + 100 * n + "%)"
                    }), o.previousItems(), !1) : t(e.attr("href")).length ? (t("html, body").animate({
                        scrollTop: t(e.attr("href")).offset().top
                    }, 1e3), t(".metaportal_fn_leftnav, .metaportal_fn_leftnav_closer,.metaportal_fn_leftnav .fn__closer").removeClass("active"), !1) : void 0
                })
            },
            previousItems: function() {
                t(".metaportal_fn_leftnav .nav_holder .prev").off().on("click", function() {
                    return n--, t(".metaportal_fn_leftnav .nav_holder > ul").css({
                        transform: "translateX(-" + 100 * n + "%)"
                    }), !1
                })
            },
            ...
            applyFilter: function() {
                o.isotopeCollection(), t(".metaportal_fn_filters .checkbox").off().on("click", function() {
                    ...
                    if (e.hasClass("selected")) {
                        e.removeClass("selected"), a.find('.result_item[data-id="' + i + '"]').remove(), 0 === n.find(".result_item").length && (n.find(".clear_all").remove(), n.find(".condition_trigger").remove(), MetaPortalFilterCondition = "and"), e.find('input[type="checkbox"]').prop("checked", ""), l.text(parseInt(l.text()) - 1);
                        var c = MetaPortalFilterArray.indexOf(i); - 1 !== c && MetaPortalFilterArray.splice(c, 1)
            ...
            recallGridAfterFiltering: function(e) {
                ...
                if ("clear" === e) return a.isotope({
                    filter: "*"
                }), MetaPortalFilterArray = [], MetaPortalFilterCondition = "and", !1;
                var n = "";
            ...
            removeFilter: function() {
                t(".metaportal_fn_result_box .result_item a").off().on("click", function() {
                    ...
                    }), MetaPortalFilterCondition = "or"), o.recallGridAfterFiltering(), !1
                })
            },
            ...
            headerAnchor: function() {
                t(".header .nav a,.metaportal_fn_mobnav .mob_bot li a").on("click", function() {
                    var e = t(this);
                    t(e.attr("href")).length && t("html, body").animate({
                        scrollTop: t(e.attr("href")).offset().top
                    }, 1e3)
                })
            },
            resizeWalletAndLeftNav: function() {
                ...
                t(".metaportal_fn_walletbox .walletbox").css({
                    minHeight: e
                });
                var a = t(".metaportal_fn_leftnav").height();
                t(".metaportal_fn_leftnav .navbox").css({
                    minHeight: a
                })
            },
            ready: function() {
            ...
            walletAndLeftNavOpener: function() {
                ...
                i.on("click", function() {
                    return i.hasClass("active") ? (i.removeClass("active"), r.slideUp(300)) : (i.addClass("active"), r.slideDown(300)), !1
                })
            },
            preloader: function() {
                if (e) return !1;
                ...
                var n = new Date - a,
                    o = 2e3;
                n < o ? o -= n : o = 0, setTimeout(function() {
            ...
            seachSomething: function() {
                var e = t(".metaportal_fn_search"),
                    ...
                    i = a.find("a");
                e.on("click", function() {
                    return a.hasClass("active") ? (a.removeClass("active"), n.removeClass("active")) : (a.addClass("active"), n.addClass("active"), o.val(""), setTimeout(function() {
                        o[0].focus()
                    }, 100)), !1
                }), n.on("click", function() {
            ...
            totopScroll: function() {
                t(".metaportal_fn_totop").off().on("click", function(e) {
                    ...
                    return a < 500 && (a = 500), a > 1500 && (a = 1500), t("html, body").animate({
                        scrollTop: 0
                    }, a), !1
                })
            },
            contactForm: function() {
                t(".contact_form #send_message").on("click", function() {
                    ...
                    return t(".contact_form .returnmessage").empty(), "" === e || "" === a || "" === i ? t(".contact_form .empty_notice").slideDown(500).delay(2e3).slideUp(500) : t.post("modal/contact.php", {
                        ajax_name: e,
                        ajax_email: a,
                        ajax_subject: o,
                        ajax_message: i,
                ...
                t(".fn_cs_collection").each(function() {
                    ...
                    setInterval(function() {
                        ...
                        o.addClass("ready"), i.addClass("ready"), setTimeout(function() {
                            o.find("input").val(s), o.find(".abs_img").css({
            ...
            fn_cs_counter: function() {
                t(".fn_cs_counter").each(function() {
                    ...
                    e.waypoint({
                        handler: function() {
                            e.hasClass("stop") || e.addClass("stop").countTo({
                                refreshInterval: 50,
            ...
            slider: function() {
                t(".fn_cs_slider").each(function() {
                    ...
                    e.find(".slider_nav .prev").off().on("click", function() {
                        return clearInterval(r), i--, i = o.sliderDo(a, n, i), r = setInterval(function() {
                            i++, i = o.sliderDo(a, n, i)
                        }, 6e3), !1
                        ...
                        if ("next" === s ? (e.stopPropagation(), e.preventDefault(), i++) : "prev" === s && (e.stopPropagation(), e.preventDefault(), i--), "next" === s || "prev" === s) return clearInterval(r), i = o.sliderDo(a, n, i), r = setInterval(function() {
                            i++, i = o.sliderDo(a, n, i)
                        }, 6e3), !1
                    })
                })
    ...
    t(document).ready(function() {
        o.init(), setTimeout(function() {
            o.isotope(), o.isotopeCollection()
        }, 150)
    }), t(window).on("resize", function() {
        o.floww_calc_call(), o.resizeWalletAndLeftNav(), o.totopFixer(), o.isotope(), o.isotopeCollection(), o.roadmapSwiper()
    }), t(window).on("load", function() {
        o.preloader(), o.isotope(), o.isotopeCollection(), setTimeout(function() {
            o.isotope(), o.isotopeCollection()
        }, 200)
